...
#[cfg(fuzzing)]
const RAK_PRIV_KEY: [u8; 48] = [60, 140, 180, 183, 23, 21, 46, 76,
                                243, 33, 155, 38, 242, 82, 86, 0, 57,
                                97, 140, 67, 71, 234, 13, 22, 87, 140,
                                136, 172, 120, 226, 162, 115, 202, 242,
                                116, 10, 141, 245, 16, 119, 255, 31,
                                1, 3, 10, 113, 218, 134];
...
pub fn get_token(
    ...
    if cfg!(not(fuzzing)) {
        ...
        Attestation::new(&plat_token(), &RAK_PRIV_KEY).create_attestation_token(
            challenge,
            measurements,
            personalization_value,
            hash_algo,
